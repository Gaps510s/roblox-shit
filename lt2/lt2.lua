...
local Converted = {
	...
	["_executortext"] = Instance.new("TextBox");
...
Converted["_executortext"].Font = Enum.Font.Gotham
Converted["_executortext"].PlaceholderColor3 = Color3.fromRGB(84.00000259280205, 85.0000025331974, 91.00000217556953)
Converted["_executortext"].PlaceholderText = "-- Welcome to Incognito. Be careful executing unknown scripts there are vulns!"
Converted["_executortext"].RichText = true
Converted["_executortext"].Text = ""
Converted["_executortext"].TextColor3 = Color3.fromRGB(212.00000256299973, 211.00000262260437, 212.00000256299973)
Converted["_executortext"].TextSize = 14
Converted["_executortext"].TextWrapped = true
Converted["_executortext"].TextXAlignment = Enum.TextXAlignment.Left
Converted["_executortext"].TextYAlignment = Enum.TextYAlignment.Top
Converted["_executortext"].BackgroundColor3 = Color3.fromRGB(24.000000469386578, 24.000000469386578, 30.00000011175871)
Converted["_executortext"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_executortext"].BorderSizePixel = 0
Converted["_executortext"].Position = UDim2.new(0.0192982461, 0, 0.116343491, 0)
Converted["_executortext"].Size = UDim2.new(0, 548, 0, 233)
Converted["_executortext"].Name = "executortext"
Converted["_executortext"].Parent = Converted["_executorpage"]
...
Converted["_execute"].MouseButton1Click:Connect(function()
    local execute = Converted["_executortext"].Text
    loadstring(execute)()
end)
